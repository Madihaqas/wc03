...
\begin{parts}
  ...
  \begin{solution}
    ...
    \begin{tabular}{C||C}
      ...
      \hline\hline
      \lnot p &  p\implies false\\
      p \lor q &  (p \implies false)\implies q\\
      p \land q & (p \implies (q\implies false))\implies false\\
      p \implies q & p \implies q  \\
      p \iff q & [(p\implies q)\implies((q\implies p)\implies false)]\implies false\\
    \end{tabular}
  \end{solution}
  \newpage
